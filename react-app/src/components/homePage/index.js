...
function HomePage() {
      ...
      return (
        ...
        <p>There are many dating apps on the market today, but most are driven by superficial algorithems.
        ...
        <p>Users are not given a selection of random faces and profiles to choose from, but instead given a general feed of posts from Users in their area. Allowing connections
          to be built on activites and interest shared between Users.
        </p>
        <p>Users are limited in their interaction with User posts simply "Admire" or scroll past, so to limit any unnecessary hate or confrontation.
        ...
        <p> Meaningful connections are missed everyday due to peoples natural lean toward a "Type" or "Preference" in a partner. We take the standard concept of dating and
